...
export const metadata = {
    ...
    description: 'Browse open contractor bidding opportunities with Andromeda Protocol',
};
        ...
        <main className="container mx-auto p-4 md:p-6 max-w-7xl min-h-screen bg-[#0f0f0f] text-white">
            <div className="mb-8">
                ...
                <p className="text-gray-400">
                    Browse open contracting opportunities with Andromeda Protocol. These are tasks that we&apos;re
                    actively seeking contractors to complete.
                </p>
            </div>
            ...
            {issues.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 px-4 bg-[#1a1a1a] rounded-lg border border-[#333333]">
                    <h3 className="text-xl font-medium text-white mb-2">No Open Bids Available</h3>
                    <p className="text-gray-400 text-center max-w-md">
                        There are currently no open contractor bids available. Please check back later or
