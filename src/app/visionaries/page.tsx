...
export default function VisionariesPage() {
  const baseDiscussionUrl =
    "https://github.com/andromedaprotocol/ado-database-hackerboard/discussions/new?category=";
    ...
    <main className="container mx-auto p-4 md:p-6 max-w-7xl min-h-screen bg-[#1a1a1a] text-white">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-lg text-gray-400 mb-8 max-w-3xl mx-auto">
          Share Your Ideas & Creations! Help shape the future of Andromeda by
          proposing new ADOs (Andromeda Digital Objects), suggesting features,
          or sharing your projects. Start a discussion in the appropriate
          category on GitHub.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        {" "}
        {/* Changed to lg:grid-cols-3 for 5 items */}
        ...
        <div className="bg-[#1a1a1a] rounded-lg border border-[#333333] p-6 flex flex-col hover:shadow-lg hover:border-gray-500 transition-all duration-300">
          ...
          <p className="text-gray-400 mb-6 flex-grow">
            Already built an ADO? Share it with the community for evaluation and
            potential inclusion.
          </p>
          <Button
            asChild
        ...
        <div className="bg-[#1a1a1a] rounded-lg border border-[#333333] p-6 flex flex-col hover:shadow-lg hover:border-gray-500 transition-all duration-300">
          ...
          <p className="text-gray-400 mb-6 flex-grow">
            Built something cool with Andromeda? Share your projects, demos, and
        ...
        <div className="bg-[#1a1a1a] rounded-lg border border-[#333333] p-6 flex flex-col hover:shadow-lg hover:border-gray-500 transition-all duration-300">
          ...
          <p className="text-gray-400 mb-6 flex-grow">
            Have other feedback, questions, or topics to discuss with the
            Andromeda team and community?
          </p>
          <Button
            asChild
      ...
      <div className="text-center p-6 bg-[#1a1a1a] rounded-lg border border-[#333333]">
        ...
        <p className="text-gray-400 mb-4">
          Your ideas and creations help shape the future of the Andromeda
          ecosystem. By contributing your thoughts and creativity, you are
          directly influencing the development of new features and capabilities.
        </p>
