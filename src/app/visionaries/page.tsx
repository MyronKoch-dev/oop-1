...
export const metadata: Metadata = {
  ...
  description:
    "Submit your ADO or feature ideas to help shape the future of Andromeda Protocol",
};
      ...
      <div className="container mx-auto p-4 md:p-6">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold mb-4 text-white">
            Submit Your ADO or Feature Idea
          </h1>
          <p className="text-lg text-gray-400 mb-8 max-w-3xl mx-auto">
            Help shape the future of Andromeda by proposing new ADOs (Andromeda
            Digital Objects) or suggesting features for existing ones. Choose
            the appropriate template below to get started on GitHub.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-[#1a1a1a] rounded-lg border border-[#333333] p-6 flex flex-col">
            ...
            <p className="text-gray-400 mb-6 flex-grow">
              Already built an ADO? Submit your completed work to be included in
              the Andromeda ecosystem.
            </p>
            <Button
              asChild
          ...
          <div className="bg-[#1a1a1a] rounded-lg border border-[#333333] p-6 flex flex-col">
            ...
            <p className="text-gray-400 mb-6 flex-grow">
              Have a different type of request or feedback? Create a blank issue
              to share with the Andromeda team.
            </p>
            <Button
              asChild
        ...
        <div className="text-center p-6 bg-[#1a1a1a] rounded-lg border border-[#333333]">
          ...
          <p className="text-gray-400 mb-4">
            Your ideas help shape the future of the Andromeda ecosystem. By
            contributing your thoughts and creativity, you&apos;re directly
            influencing the development of new features and capabilities.
          </p>
          <p className="text-gray-400">
            The Andromeda team reviews all submissions and may reach out to
