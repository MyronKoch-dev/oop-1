        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <DialogDescription className="text-gray-300 text-sm leading-relaxed text-left">
              ...
              dApp. Whether you&apos;re creating a token, launching a
              marketplace, or building a full-on Web3 app, every active ADO you
              deploy stacks your rewards. Check out the ADOs below and start
              building.
            </DialogDescription>

            <DialogDescription className="text-gray-300 text-sm leading-relaxed text-left">
              Not sure what to build? Complete one of our use cases and earn
              2,000 $ANDR
            </DialogDescription>
            ...
            <div className="space-y-3 pt-2">
              <button
                onClick={() =>
                  window.open("https://youtu.be/tfY8ni9uJSE", "_blank")
                }
              ...
              <button
                onClick={() =>
                  window.open("https://youtu.be/rOKXu_NNfyk", "_blank")
                }
                className="w-full bg-gray-700 hover:bg-gray-600 text-white px-4 py-3 rounded-lg transition-colors flex items-center justify-center gap-3"
              >
                <span className="text-lg">▶</span>
